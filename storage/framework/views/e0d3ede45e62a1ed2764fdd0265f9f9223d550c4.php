    			...
    			<div class="row">
    				...
    				<div class="col-md-8">
    					<div class="cont_txt">
    						...
    						<h4 class="autom_under title_txt_1"><?php echo e($book->published_date); ?></h4>
    						
    						<p class="lorem_txt title_txt_1"><?php echo e($book->story_summary); ?></p>
    						
    						<p class="lorem_txt title_txt_1"><?php echo e($book->book_summary); ?></p>
    						
    						<a href="<?php echo e($book->link); ?>" class="title_txt_1" target="_blank"><?php echo e($book->link); ?></a>
    						
    						
            				<h2 class="title_txt_1"><?php echo e($book->curriculum_level); ?></h2>
                			
                			
                			
            				<h2 class="title_txt_1"><?php echo e($book->text_type); ?></h2>
