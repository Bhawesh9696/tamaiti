                <div class="side-nav-inner">
					<ul class="side-nav-menu">
						...
						<li class="nav-item dropdown open">
							<a href="#" class="dropdown-toggle"> <span class="icon-holder"> <i class="lni-dashboard"></i> </span>  <span class="title"><a href="<?php echo e(url('/dashboard')); ?>" style="margin-left: 50px; margin-top: -45px;">Dashboard</a></span>
							</a>
						</li>
