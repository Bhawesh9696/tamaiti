                <div class="side-nav-inner">
					<ul class="side-nav-menu">
						...
						<li class="nav-item dropdown open">
							<a href="#" class="dropdown-toggle"> <span class="icon-holder"> <i class="lni-dashboard"></i> </span>  <span class="title"><a href="<?php echo e(route('dashboard1')); ?>" style="margin-left: 50px; margin-top: -45px;">Dashboard</a></span>
							</a>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu sub-down">
								<li> <a href="<?php echo e(url('/admin/add-popular-number')); ?>">Add Excel Sheet</a>
								</li>
								<li> <a href="<?php echo e(url('/admin/popular-number-list')); ?>">Manage Excel Sheet</a>
								</li>
							</ul>
						</li>
                        ...
                        <li class="nav-item dropdown">
							...
							<ul class="dropdown-menu sub-down">
								<li> <a href="<?php echo e(url('/admin/changePassword')); ?>">Change Password</a>
								</li>	
							</ul>
						</li>  
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu sub-down">
								<li> <a href="<?php echo e(url('/admin/user-list')); ?>">Show Users</a>
								</li>	
							</ul>
						</li>
