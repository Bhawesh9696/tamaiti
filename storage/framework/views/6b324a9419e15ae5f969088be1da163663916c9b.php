		...
		<section class="top_header">
		  <div class="container">
			  <div class="logo_center">
				<img src="<?php echo e(url('/')); ?>/public/images/logo_main.png" alt="Logo"></div>
		 </div>
		</section>
    </header>
		                       ...
		                       <?php endif; ?>
								...
								<div class="tab-content" id="pills-tabContent">
								  <div class="tab-pane fade show active" id="sign_up" role="tabpanel" aria-labelledby="sign_up-tab">
									<form id="popularID" role="form" action="<?php echo e(route('saveUserRegistration')); ?>" method="POST" enctype="multipart/form-data">
							...
							"email": {
								...
								required: "password should not be blank.",
								  ...
								  <div class="tab-pane fade" id="login_up" role="tabpanel" aria-labelledby="login_up-tab">
									<form class="signup" id="login" role="form" action="<?php echo e(route('UserLogin')); ?>" method="POST" enctype="multipart/form-data">
										<?php echo e(csrf_field()); ?>
		...
		<script src="<?php echo e(URL::asset('public/backend/js/jquery.validate.min.js')); ?>"></script>
		 ...
		 <style>
			.error{color: #f95029 !important;}
						...
						<div class="col-lg-7">
							<figure>
								<img src="<?php echo e(url('/')); ?>/public/images/right_form.png" alt="">
							</figure>
						</div>
					</div>
			</div>
...
<script>window.jQuery || document.write('<script src="<?php echo e(url('/')); ?>/public/js/jquery-slim.min.js"><\/script>')</script>
