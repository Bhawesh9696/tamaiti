            <div class="header navbar">
				<div class="header-container">
					<div class="nav-logo">
						<a href="<?php echo e(url('/dashboard')); ?>" style="color: #E22A6F; font-weight: 800;"> <b><img src="<?php echo e(url('public/backend/img/logo.png')); ?>" alt=""></b>  <span class="logo"> <!-- <img src="assets/img/logo-text.png" alt=""> -->Tamaiti </span> 
						</a>
					</div>
					<ul class="nav-left">
						<li>
