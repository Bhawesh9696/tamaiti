					...
					<ul class="side-nav-menu">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu sub-down">
								<li> <a href="<?php echo e(url('/add-popular-number')); ?>">Add Excel Sheet</a>
								</li>
								<li> <a href="<?php echo e(url('/popular-number-list')); ?>">Manage Excel Sheet</a>
								</li>
							</ul>
						</li>
                        ...
                        <li class="nav-item dropdown">
							...
							<ul class="dropdown-menu sub-down">
								<li> <a href="<?php echo e(url('changePassword')); ?>">Change Password</a>
								</li>	
							</ul>
						</li>  
