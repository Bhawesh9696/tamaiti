            <div class="header navbar">
				<div class="header-container">
					<div class="nav-logo">
						<a href="<?php echo e(route('dashboard1')); ?>" style="color: #E22A6F; font-weight: 800;"> <b><img src="<?php echo e(url('public/backend/img/logo.png')); ?>" alt=""></b>  <span class="logo"> <!-- <img src="assets/img/logo-text.png" alt=""> -->Tamaiti logo</span> 
						</a>
					</div>
					<ul class="nav-left">
						<li>
					...
					<ul class="nav-right">
						...
						<li class="user-profile dropdown dropdown-animated scale-left">
							...
							<!--	<li>
								...
								<li><a href="<?php echo e(route('admin.logout')); ?>"> <i class="lni-lock"></i><span>Logout</span> </a>
								</li>
							</ul>
						</li>
					</ul>
