		  ...
		  <div class="container-fluid">
			<div class="container">
			  	<div class="row">
					<div class="col-md-2">
						<a href="#">
							<img src="{{url('/')}}/public/images/logo_main.png" alt="Logo">
						</a>
					</div>
      ...
      <!-- Wrap the rest of the page in another container to center all the content. -->
        ...
        <div class="carousel-inner">
          <div class="carousel-item">
            <img class="first-slide" src="{{url('/')}}/public/images/banner-1.png" alt="Image">
			  <div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="author_box">
							<img src="{{url('/')}}/public/images/author_img.png" alt="">
						</div>
					</div>
